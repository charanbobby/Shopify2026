...
| Dscopify (B2B) | Storefront-Widget + Backend-API | **Partial** - Should Have; not MVP blocker | Shopify B2B / Dscopify App | Medium | **High** | B2B UI (company profiles, bulk ordering, price lists) is extensive in headless React. [[Ref](https://shopify.dev/docs/api/storefront)] |
